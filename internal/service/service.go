...
// Service - это слой, где происходит вся основная "магия".
// Он решает, кого назначить, проверяет права и т.д.
type Service struct {
...
func (s *Service) CreateTeam(team *models.Team) error {
	...
	// Создаём или обновляем инфу по пользователям в команде
...
// selectRandomReviewers - моя функция для выбора случайных ревьюеров.
...
// filterAssignedReviewers - убирает из списка кандидатов тех, кто уже назначен на PR, и автора.
